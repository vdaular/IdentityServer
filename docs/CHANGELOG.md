...
Identity Server 8.0.4 is a security release that addresses hundreds of security vulnerabilities in the IdentityServer9 code base. We recommend that you update to this version.

- Fix over 100+ security vulnerabilities in the IdentityServer9 code base:
...
- Documentation Website: IdentityServer9.readthedocs.io has been created and is now the official documentation website for IdentityServer9
- Gitter: A Gitter chat room has been created for IdentityServer9. You can join the chat at https://app.gitter.im/#/room/#IdentityServer9:gitter.im
- Framework Upgrade: Upgrade Samples, including Clients, Quickstarts, and Key Management, to use DotNet 8 sdk style.
- [Quickstarts] (https://github.com/alexhiggins732/IdentityServer9/tree/master/samples/Quickstarts) - Updated Quickstart samples to use Dotnet 8 startup with implicit usings and minimal Api.
- [Clients] (https://github.com/alexhiggins732/IdentityServer9/tree/master/samples/Clients) - Updated client samples to use Dotnet 8 startup with implicit usings and minimal Api.
- [Key Management] (https://github.com/alexhiggins732/IdentityServer9/tree/master/samples/KeyManagement) - Updated Key management samples to use Dotnet 8 startup with implicit usings and minimal Api. Changed default Entity Framework storage to file system storage as original Key Management is a paid solution. Roadmap: Add DbContext implementation fof key management.
...
### Added
- `IdentityServer9.Security` nuget packages with services to sanitize user input including html, json, xml, javascript, scripts, urls, logs, css, and style sheets.

### Changed
- [Account Login Controller] (https://github.com/alexhiggins732/IdentityServer9/issues/9) 
- [Account Login View] (https://github.com/alexhiggins732/IdentityServer9/issues/9)  
...
- [IdentityServer9 8.0.1 changes]https://github.com/alexhiggins732/IdentityServer9/pull/7) 
