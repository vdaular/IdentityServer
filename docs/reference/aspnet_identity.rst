...
The repo for this support is located `here <https://github.com/alexhiggins732/IdentityServer9.AspNetIdentity/>`_ and the NuGet package is `here <https://www.nuget.org/packages/HigginsSoft.IdentityServer9.AspNetIdentity>`_.
