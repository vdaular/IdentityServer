...
IdentityServer9 allows adding support for other protocols besides the built-in 
...
A sample for adding WS-Federation support can be found `here <https://github.com/alexhiggins732/IdentityServer9.WsFederation>`_.
