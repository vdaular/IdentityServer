...
or use the `identity server authentication handler <https://github.com/alexhiggins732/IdentityServer9.AccessTokenValidation>`_ which can validate both JWTs and reference tokens.
