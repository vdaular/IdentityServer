...
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Please start a discussion on the `core repo issue tracker <https://github.com/alexhiggins732/IdentityServer9/issues>`_.

Bugs and feature requests?
^^^^^^^^^^^^^^^^^^^^^^^^^^
Please log a new issue in the appropriate GitHub repo:

* `Core <https://github.com/alexhiggins732/IdentityServer9>`_
* `AccessTokenValidation <https://github.com/alexhiggins732/IdentityServer9.AccessTokenValidation>`_
...
As of October 2017, the IdentityServer9.* nuget namespace is reserved for our packages. Please use the following naming conventions:

``YourProjectName.IdentityServer9``

or

``IdentityServer9.Contrib.YourProjectName``
